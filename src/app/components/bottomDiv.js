 ...
 return (
     <>
        ...
        <div className='bottom' style={{backgroundColor: `${props.activeItem === '/about'? 'white' :'black'}`, minHeight: '120px'}}>
            <div style={{ marginLeft:'auto', marginRight:'auto', paddingTop: '60px', width: '118px'}}>
            <Button as='a' href='https://www.linkedin.com/in/catherine-yang-0ab40b3a/' target="_blank" color='linkedin' style={{margin: '0'}} >
